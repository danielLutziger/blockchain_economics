...
contract USDUZHNEW {
    ...
    string public constant name = "USDUZH";
    string public constant symbol = "USDUZH";
    ...
    constructor() {
	    totalSupply_ = 1000000000000000000000000000000000000000000000000 * 10*18; // Multiplied by 10*18 because of 18 decimals
